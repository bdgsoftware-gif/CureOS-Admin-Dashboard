      ...
      connectedCallback() {
        ...
        <div class="flex md:justify-between justify-center w-full gap-4">
          ...
          <div class="md:flex hidden gap-4 item-center md:justify-end">
            ...
            <a href="mailto:support@endbrackets.com" class="text-sm leading-5 text-zinc-600 transition hover:text-zinc-900" target="_blank">Support</a>
            <span class="border-e border-gray-300 "></span>
            <a href="https://endbrackets.com/#contact" class="text-sm leading-5 text-zinc-600 transition hover:text-zinc-900" target="_blank">Contact Us</a>
          </div>
        </div>
      </footer>`
      }
