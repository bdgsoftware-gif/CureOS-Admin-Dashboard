...
Object.keys(icons).forEach(function (key) {
    if (key === "Editor") {
        iconData =
            iconData +
            '<div class="card"><div class="p-6"><h4 class="card-title mb-2">' +
            key +
            ' </h4><p class="mb-2">Use <code>&lt;i class="ri-bold"&gt;&lt;/i&gt;</code></p><div class="grid lg:grid-cols-4 md:grid-cols-2 gap-6 icons-list-demo">';
        ...
        iconData =
            ...
            '<div class="card"><div class="p-6"><h4 class="card-title mb-2">' +
            key +
            ' </h4><p class="mb-2">Use <code>&lt;i class="ri-home-line"&gt;&lt;/i&gt;</code> or <code>&lt;i class="ri-home-fill"&gt;&lt;/i&gt;</code></p><div class="grid lg:grid-cols-4 md:grid-cols-2 gap-6 icons-list-demo">';
        Object.keys(icons[key]).forEach(function (k) {
            iconData +=
                '<div>\
                        <i class="ri-' +
