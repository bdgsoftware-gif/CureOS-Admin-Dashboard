...
var chart = new ApexCharts(document.querySelector("#widget-orders"), options);
...
var chart = new ApexCharts(document.querySelector("#widget-revenue"), options);
...
var chart = new ApexCharts(document.querySelector("#widget-growth"), options);
