@extends('layouts.vertical', ['title' => 'Nestable', 'subTitle' => 'Extended', 'pageTitle' => 'Nestable'])
                ...
                <div class="bg-light p-4 rounded-md dark:bg-gray-700">
                    ...
                    <div id="move-left" class="space-y-3 h-full">
                        <div class="card">
                            <div class="p-6">
                                <div class="flex items-start">
                                    <img src="/images/users/avatar-1.jpg" alt="image" class="me-3 h-12 w-12 rounded-full">
                                    <div class="flex-grow overflow-hidden">
                                        <h5 class="mb-1 mt-0">Louis K. Bond</h5>
                                        <p class="mb-2"> Founder & CEO </p>
                                        <p>
                                            <span class="italic"><b>"</b>Disrupt pork belly poutine, asymmetrical tousled succulents selfies. You probably haven't heard of them tattooed master cleanse live-edge keffiyeh.</span>
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card">
                            <div class="p-6">
                                <div class="flex items-start">
                                    <img src="/images/users/avatar-2.jpg" alt="image" class="me-3 h-12 w-12 rounded-full">
                                    <div class="flex-grow overflow-hidden">
                        ...
                        <div class="card">
                            <div class="p-6">
                                <div class="flex items-start">
                                    <img src="/images/users/avatar-3.jpg" alt="image" class="me-3 h-12 w-12 rounded-full">
                                    <div class="flex-grow overflow-hidden">
                ...
                <div class="bg-light p-4 rounded-md dark:bg-gray-700">
                    ...
                    <div id="move-right" class="space-y-3 h-full">
                        <div class="card">
                            <div class="p-6">
                                <div class="flex items-start">
                                    <img src="/images/users/avatar-4.jpg" alt="image" class="me-3 h-12 w-12 rounded-full">
                                    <div class="flex-grow overflow-hidden">
                        ...
                        <div class="card">
                            <div class="p-6">
                                <div class="flex items-start">
                                    <img src="/images/users/avatar-5.jpg" alt="image" class="me-3 h-12 w-12 rounded-full">
                                    <div class="flex-grow overflow-hidden">
                        ...
                        <div class="card">
                            <div class="p-6">
                                <div class="flex items-start">
                                    <img src="/images/users/avatar-6.jpg" alt="image" class="me-3 h-12 w-12 rounded-full">
                                    <div class="flex-grow overflow-hidden">
                ...
                <div class="bg-light p-4 rounded-md dark:bg-gray-700">
                    ...
                    <div id="moveHandle-left" class="space-y-3 h-full">
                        <div class="card">
                            <div class="p-6">
                                <div class="flex items-start">
                                    <img src="/images/users/avatar-7.jpg" alt="image" class="me-3 h-12 w-12 rounded-full">
                                    <div class="flex-grow overflow-hidden">
                        ...
                        <div class="card">
                            <div class="p-6">
                                <div class="flex items-start">
                                    <img src="/images/users/avatar-8.jpg" alt="image" class="me-3 h-12 w-12 rounded-full">
                                    <div class="flex-grow overflow-hidden">
                        ...
                        <div class="card">
                            <div class="p-6">
                                <div class="flex items-start">
                                    <img src="/images/users/avatar-9.jpg" alt="image" class="me-3 h-12 w-12 rounded-full">
                                    <div class="flex-grow overflow-hidden">
                ...
                <div class="bg-light p-4 rounded-md dark:bg-gray-700">
                    ...
                    <div id="moveHandle-right" class="space-y-3 h-full">
                        <div class="card">
                            <div class="p-6">
                                <div class="flex items-start">
                                    <img src="/images/users/avatar-10.jpg" alt="image" class="me-3 h-12 w-12 rounded-full">
                                    <div class="flex-grow overflow-hidden">
        ...
        <div class="p-6">
            ...
            <div class="grid md:grid-cols-2 gap-5">
                ...
                <div id="example2-right" class="flex flex-col gap-3">
                    <div class="rounded cursor-grab px-6 py-3 border border-gray-200 dark:border-gray-600 tinted">Item 1</div>
                    <div class="rounded cursor-grab px-6 py-3 border border-gray-200 dark:border-gray-600 tinted">Item 2</div>
                    <div class="rounded cursor-grab px-6 py-3 border border-gray-200 dark:border-gray-600 tinted">Item 3</div>
                    <div class="rounded cursor-grab px-6 py-3 border border-gray-200 dark:border-gray-600 tinted">Item 4</div>
                    <div class="rounded cursor-grab px-6 py-3 border border-gray-200 dark:border-gray-600 tinted">Item 5</div>
                    <div class="rounded cursor-grab px-6 py-3 border border-gray-200 dark:border-gray-600 tinted">Item 6</div>
                </div>
            </div>
    ...
    <div class="card">
        <div class="p-6">
            ...
            <div id="example4" class="flex flex-col gap-3">
                ...
                <div class="rounded cursor-grab px-6 py-3 border border-gray-200 dark:border-gray-600">Item 2</div>
                <div class="rounded cursor-grab px-6 py-3 border border-gray-200 dark:border-gray-600">Item 3</div>
                <div class="filtered rounded border px-6 py-3 bg-danger text-white border-gray-200 dark:border-gray-600">Filtered</div>
                <div class="rounded cursor-grab px-6 py-3 border border-gray-200 dark:border-gray-600">Item 4</div>
                <div class="rounded cursor-grab px-6 py-3 border border-gray-200 dark:border-gray-600">Item 5</div>
            </div>
        </div>
