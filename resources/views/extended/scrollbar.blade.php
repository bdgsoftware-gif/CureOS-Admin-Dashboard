@extends('layouts.app', ['title' => 'Scrollbar', 'subTitle' => 'Extended', 'pageTitle' => 'Scrollbar'])
...
@section('content')
    <div class="grid md:grid-cols-2 gap-6">
        ...
        <div class="card">
            ...
            <div class="py-6 px-1">
                <div class="custom-scroll overflow-auto h-56 px-5">
                    <div class="max-w-full">
                        <p class="text-lg text-slate-700 dark:text-slate-400">Tailwind CSS works by scanning all of your HTML
                            files, JavaScript components, and any other templates for class names, generating the
                        ...
                        <p class="mt-4 text-lg text-slate-700 dark:text-slate-400">Combined with minification and network
                            ...
                            For example, Netflix uses Tailwind for <a class="underline" target="_blank"
                                href="https://top10.netflix.com/">Netflix Top 10</a> and the entire website delivers only
                            6.5kB of CSS over the network.</p>
        ...
        <div class="card">
            ...
            <div class="py-6">
                <div class="h-56 px-6" data-simplebar>
        ...
        <div class="card">
            ...
            <div class="py-6">
                <div class="h-56 px-6" data-simplebar data-simplebar-direction='rtl'>
                    <div class="prose max-w-full text-slate-700 dark:text-slate-400">
                        SimpleBar does only one thing: replace the browser's default scrollbar
                        with a custom CSS-styled one without losing performances.
                        Unlike some popular plugins, SimpleBar doesn't mimic scroll with
        ...
        <div class="card">
            ...
            <div class="py-6">
                <div class="h-56 px-6" data-simplebar data-simplebar-lg>
        ...
        <div class="card">
            ...
            <div class="py-6">
                <div class="h-56 px-6" data-simplebar data-simplebar-primary>
                    <div class="prose max-w-full text-slate-700 dark:text-slate-400">
                        SimpleBar does only one thing: replace the browser's default scrollbar
                        with a custom CSS-styled one without losing performances.
                        Unlike some popular plugins, SimpleBar doesn't mimic scroll with
