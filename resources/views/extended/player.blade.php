@extends('layouts.app', ['title' => 'Player', 'subTitle' => 'Extended', 'pageTitle' => 'Player'])
        ...
        <div class="card overflow-hidden">
            <div class="p-6">
                ...
                <div class="rounded-xl overflow-hidden">
                    <div id="player-youtube" data-plyr-provider="youtube" data-plyr-embed-id="bTqVqk7FSmY" allowfullscreen>
                    </div>
                </div>
            </div>
        </div>
