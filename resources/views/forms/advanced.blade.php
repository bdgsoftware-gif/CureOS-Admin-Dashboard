@extends('layouts.vertical', ['title' => 'Advanced', 'subTitle' => 'Forms', 'pageTitle' => 'Advanced'])
            ...
            <div class="section">
                ...
                <div class="mb-6">
                    ...
                    <div class="grid xl:grid-cols-3 md:grid-cols-2 gap-6">
                        <div>
                            <label class="mb-2" for="choices-text-remove-button">Limited to 5 values with remove button</label>
                            <input class="form-input" id="choices-text-remove-button" type="text" value="Preset-1,Preset-2,Preset-3" placeholder="Enter something" />
                        </div>

                        <div>
                            <label class="mb-2" for="choices-text-unique-values">Unique values only, no pasting</label>
                            <input class="form-input" id="choices-text-unique-values" type="text" value="preset-1, preset-2" placeholder="This is a placeholder" class="custom class" />
                        </div>

                        <div>
                            <label class="mb-2" for="choices-text-email-filter">Email addresses only</label>
                            <input class="form-input" id="choices-text-email-filter" type="text" placeholder="This is a placeholder" />
                        </div>

                        <div>
                            <label class="mb-2" for="choices-text-disabled">Disabled</label>
                            <input class="form-input" id="choices-text-disabled" type="text" value="josh@joshuajohnson.co.uk, joe@bloggs.co.uk" placeholder="This is a placeholder" />
                        </div>

                        <div>
                            <label class="mb-2" for="choices-text-prepend-append-value">Prepends and appends a value to each items return value</label>
                            <input class="form-input" id="choices-text-prepend-append-value" type="text" value="preset-1, preset-2" placeholder="This is a placeholder" />
                        </div>

                        <div>
                            <label class="mb-2" for="choices-text-preset-values">Preset values passed through options</label>
                            <input class="form-input" id="choices-text-preset-values" type="text" value="Michael Smith" placeholder="This is a placeholder" />
                        </div>
                ...
                <div class="mb-6">
                    ...
                    <div class="grid xl:grid-cols-3 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <select class="form-input" data-trigger name="choices-multiple-default" id="choices-multiple-default" placeholder="This is a placeholder" multiple>
                        ...
                        <div>
                            ...
                            <select class="form-input" name="choices-multiple-groups" id="choices-multiple-groups" placeholder="This is a placeholder" multiple>
                        ...
                        <div>
                            <label class="mb-2" for="choices-multiple-remote-fetch">Options from remote source (Fetch API) &amp; limited to 5</label>
                            <select class="form-input" name="choices-multiple-remote-fetch" id="choices-multiple-remote-fetch" multiple></select>
                        </div>

                        <div>
                            <label class="mb-2" for="choices-multiple-labels">Use label in event (add/remove)</label>
                            <p id="message"></p>
                ...
                <div class="mb-6">
                    ...
                    <div class="grid xl:grid-cols-3 md:grid-cols-2 gap-6">
                        <div>
                            <label class="mb-2" id="choices-single-default-label" for="choices-single-default">Default</label>
                            <select class="form-input" data-trigger name="choices-single-default" id="choices-single-default" placeholder="This is a search placeholder">
                        ...
                        <div>
                            <label class="mb-2" for="choices-single-remote-fetch">Options from remote source (Fetch API)</label>
                            <select class="form-input" name="choices-single-remote-fetch" id="choices-single-remote-fetch">
                                <option value="">Pick an Arctic Monkeys' record</option>
                            </select>
                        </div>

                        <div>
                            <label class="mb-2" for="choices-single-remove-xhr">Options from remote source (Fetch API) &amp; remove button</label>
                            <select class="form-input" name="choices-single-remove-xhr" id="choices-single-remove-xhr">
                        ...
                        <div>
                            ...
                            <select class="form-input" data-trigger name="choices-single-groups" id="choices-single-groups">
                                <option value="">Choose a city</option>
                                <optgroup label="UK">
                                    <option value="London">London</option>
                                    <option value="Manchester">Manchester</option>
                        ...
                        <div>
                            <label class="mb-2" for="choices-single-no-search">Options added via config with no search</label>
                        ...
                        <div>
                            <label class="mb-2" for="choices-single-preset-options">Option and option groups added via config</label>
                            <select class="form-input" name="choices-single-preset-options" id="choices-single-preset-options"></select>
                        </div>

                        <div>
                            <label class="mb-2" for="choices-single-selected-option">Option selected via config with custom properties</label>
                            <select class="form-input" name="choices-single-selected-option" id="choices-single-selected-option"></select>
                        </div>

                        <div>
                            <label class="mb-2" for="choices-with-custom-props-via-html">Option searchable by custom properties via Attribute</label>
                            <select class="form-input" id="choices-with-custom-props-via-html">
                                ...
                                <option value="Dropdown item 4" data-custom-properties="{ 'description': 'foo' }">Label Four</option>
                            </select>
                        </div>

                        <div>
                            <label id="choices-single-no-sorting-label" for="choices-single-no-sorting">Options without sorting</label>
                            <select class="form-input" name="choices-single-no-sorting" id="choices-single-no-sorting">
                                <option value="Madrid">Madrid</option>
                                <option value="Toronto">Toronto</option>
                                <option value="Vancouver">Vancouver</option>
                                <option value="London">London</option>
                        ...
                        <div>
                            ...
                            <select class="form-input" name="choices-single-custom-templates" id="choices-single-custom-templates">
            ...
            <div class="grid lg:grid-cols-2 gap-6">
                <div>
                    <div class="mb-3">
                        ...
                        <input type="text" id="basic-datepicker" class="form-input" placeholder="Basic datepicker">
                    </div>

                    <div class="mb-3">
                        <label class="mb-2">Date & Time</label>
                        <input type="text" id="datetime-datepicker" class="form-input" placeholder="Date and Time">
                    </div>

                    <div class="mb-3">
                        <label class="mb-2">Human-friendly Dates</label>
                        <input type="text" id="humanfd-datepicker" class="form-input" placeholder="October 9, 2018">
                    </div>

                    <div class="mb-3">
                        <label class="mb-2">MinDate and MaxDate</label>
                        <input type="text" id="minmax-datepicker" class="form-input" placeholder="mindate - maxdate">
                    </div>

                    <div class="mb-3">
                        <label class="mb-2">Disabling dates</label>
                        <input type="text" id="disable-datepicker" class="form-input" placeholder="Disabling dates">
                    </div>

                    <div class="mb-3">
                        <label class="mb-2">Selecting multiple dates</label>
                        <input type="text" id="multiple-datepicker" class="form-input" placeholder="Multiple dates">
                    </div>
                ...
                <div>
                    <div class="mb-3">
                        ...
                        <input type="text" id="conjunction-datepicker" class="form-input" placeholder="2018-10-10 :: 2018-10-11">
                    </div>

                    <div class="mb-3">
                        <label class="mb-2">Range Calendar</label>
                        <input type="text" id="range-datepicker" class="form-input" placeholder="2018-10-03 to 2018-10-10">
                    </div>

                    <div>
                        <label class="mb-2">Inline Calendar</label>
                        <input type="text" id="inline-datepicker" class="form-input" placeholder="Inline calendar">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="grid lg:grid-cols-2 gap-6">
                <div>
                    <div class="mb-3">
                        ...
                        <div class="flex items-center ">
                            <input type="text" class="form-input border-r-0 rounded-r-none" id="basic-timepicker" aria-describedby="inputGroupPrepend2">
                            <span class="btn bg-light border border-gray-200 rounded-s-none dark:border-gray-600 dark:bg-gray-600"><i class="ri-time-line"></i></span>
                        </div>
                    </div>
                    ...
                    <div class="mb-0">
                        ...
                        <div class="flex items-center ">
                            <input type="text" class="form-input border-r-0 rounded-r-none" id="fullhours-timepicker" aria-describedby="inputGroupPrepend2">
                            <span class="btn bg-light border border-gray-200 rounded-s-none dark:border-gray-600 dark:bg-gray-600"><i class="ri-time-line"></i></span>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    <div class="mb-3">
                        ...
                        <div class="flex items-center ">
                            <input type="text" class="form-input border-r-0 rounded-r-none" id="minmax-timepicker" aria-describedby="inputGroupPrepend2">
                            <span class="btn bg-light border border-gray-200 rounded-s-none dark:border-gray-600 dark:bg-gray-600"><i class="ri-time-line"></i></span>
                        </div>
                    </div>
                    ...
                    <div class="mb-0">
                        ...
                        <div class="flex items-center ">
                            <input type="text" class="form-input border-r-0 rounded-r-none" id="preloading-timepicker" aria-describedby="inputGroupPrepend2">
                            <span class="btn bg-light border border-gray-200 rounded-s-none dark:border-gray-600 dark:bg-gray-600"><i class="ri-time-line"></i></span>
                        </div>
                    </div>
                </div>
