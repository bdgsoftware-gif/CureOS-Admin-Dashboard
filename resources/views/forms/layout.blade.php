@extends('layouts.vertical', ['title' => 'Form Layout', 'subTitle' => 'Form', 'pageTitle' => 'Form Layout'])
                    ...
                    <form>
                        <div class="flex flex-wrap items-center gap-4">
                            ...
                            <div>
                                ...
                                <div class="flex">
                                    <span class="px-4 inline-flex items-center min-w-fit rounded-l border border-r-0 border-gray-200 bg-gray-50 text-sm text-gray-500 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-400">@</span>
