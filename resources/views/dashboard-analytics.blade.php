@extends('layouts.app', ['title' => 'Analytics', 'subTitle' => 'Menu', 'pageTitle' => 'Analytics'])
    ...
    <div class="grid xl:grid-cols-3 lg:grid-cols-2 grid-cols-1 gap-6 mb-6">
        <div class="card cta-box overflow-hidden">
            <div class="p-6">
                <div class="flex items-center">
                    <div>
                        <h3 class="text-xl/7 font-normal mb-6">Enhance your <strong>Campaign</strong> for better outreach
                        </h3>
        ...
        <div class="card">
            <div class="card-header !border-0 flex justify-between items-center">
                ...
                <div>
                    <button class="text-gray-600 dark:text-gray-400" data-fc-type="dropdown" data-fc-placement="bottom-end"
                        type="button">
                    ...
                    <div
                        ...
                        <a class="flex items-center py-1.5 px-5 text-sm text-gray-500 hover:bg-slate-100 hover:text-slate-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-300"
                            href="javascript: void(0);">Refresh Report</a>
                        <a class="flex items-center py-1.5 px-5 text-sm text-gray-500 hover:bg-slate-100 hover:text-slate-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-300"
            ...
            <div class="p-6 pt-0">
                ...
                <div class="mt-1 text-center">
                    <ul class="flex items-center justify-around">
                        <li class="flex items-center"><img class="ms-3 pe-1 h-5" src="/images/browsers/chrome.png"
                                alt="chrome"><span class="align-middle">45.87%</span></li>
                        <li class="flex items-center"><img class="ms-3 pe-1 h-5" src="/images/browsers/firefox.png"
                                alt="chrome"><span class="align-middle">3.25%</span></li>
                        <li class="flex items-center"><img class="ms-3 pe-1 h-5" src="/images/browsers/safari.png"
                                alt="chrome"><span class="align-middle">9.68%</span></li>
                        <li class="flex items-center"><img class="ms-3 pe-1 h-5" src="/images/browsers/web.png"
        ...
        <div class="card">
            <div class="card-header flex justify-between items-center">
                ...
                <div>
                    ...
                    <div
                        class="hidden fc-dropdown fc-dropdown-open:opacity-100 opacity-0 w-36 z-50 mt-2 transition-all duration-300 bg-white dark:bg-gray-800 shadow-lg border border-gray-200 dark:border-gray-700 rounded-lg p-2">
            ...
            <div class="p-6">
                <div class="bg-light-subtle border-top border-bottom border-light">
                    <div class="flex flex-wrap items-center text-center">
                        ...
                        <div class="lg:w-1/4 w-1/2">
                            <p class="text-gray-400 mt-6 mb-4 text-base"><i class="ri-donut-chart-fill"></i> Organic
                                Search</p>
                            <h3 class="font-normal text-2xl text-gray-500 mb-6">
        ...
        <div class="card">
            <div class="card-header flex justify-between items-center">
                ...
                <a href="javascript:void(0);"
                    class="btn btn-sm bg-light !text-sm text-gray-800 dark:bg-light/20 dark:text-white">Export <i
                        class="ri-download-line ms-1.5"></i></a>
            </div>
                    ...
                    <table class="w-full">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="p-2">
                                    <div
                                        class="flex w-full h-[3px] bg-light rounded-full overflow-hidden dark:bg-gray-700">
