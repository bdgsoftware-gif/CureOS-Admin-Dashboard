    ...
    <div class="scrollbar" data-simplebar>
        <ul class="menu" data-fc-type="accordion">
            ...
            <li class="menu-item">
                ...
                <ul class="sub-menu hidden">
                    <li class="menu-item">
                        <a href="{{route('second', ['layouts-eg', 'hover-view'])}}" target="_blank" class="menu-link">
                            <span class="menu-text">Hovered Menu</span>
                        </a>
                    </li>
                    <li class="menu-item">
                        <a href="{{route('second', ['layouts-eg', 'icon-view'])}}" target="_blank" class="menu-link">
                            <span class="menu-text">Icon View Menu</span>
                        </a>
                    </li>
                    <li class="menu-item">
                        <a href="{{route('second', ['layouts-eg', 'compact-view'])}}" target="_blank" class="menu-link">
                            <span class="menu-text">Compact Menu</span>
                        </a>
                    </li>
                    <li class="menu-item">
                        <a href="{{route('second', ['layouts-eg', 'mobile-view'])}}" target="_blank" class="menu-link">
