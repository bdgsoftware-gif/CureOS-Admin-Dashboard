                ...
                <div class="card overflow-hidden">
                    ...
                    <div class="px-6 py-10">
                        <div class="text-center">
                            <h1 class="text-primary text-7xl drop-shadow-xl">4<i class="ri-emotion-sad-line"></i>4
                            </h1>
                            <h4 class="text-danger text-lg uppercase my-7">Page Not Found</h4>
                            <p>It's looking like you may have taken a wrong turn. Don't worry... it happens to the best
                                of us. Here's a little tip that might help you get back on track.</p>
                            <a href="{{ route('any', 'index') }}" class="btn bg-info text-white mt-10"><i
                                    class="ri-home-4-line me-2"></i> Back to Home</a>
                        </div>
                    </div>
                </div> <!-- end card -->
