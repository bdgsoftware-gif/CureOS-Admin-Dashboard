                    ...
                    <div class="flex flex-col gap-4 kanban-board custom-scroll overflow-x-hidden overflow-y-auto px-1 h-full"
                        ...
                        <div class="card cursor-pointer">
                            <div class="p-6">
                                ...
                                <h5 class="my-2">
                                    <a href="#" data-fc-type="modal" data-fc-target="task-detail-modal" type="button"
                        ...
                        <div class="card cursor-pointer">
                            <div class="p-6">
                                ...
                                <h5 class="my-2">
                                    <a href="#" data-fc-type="modal" data-fc-target="task-detail-modal"
                                        class="text-base text-gray-700 dark:text-slate-400 font-medium">Invite user to a
                                        project</a>
                                </h5>
                    ...
                    <div class="flex flex-col gap-4 kanban-board custom-scroll overflow-x-hidden overflow-y-auto px-1 h-full"
                        ...
                        <div class="card cursor-pointer">
                            <div class="p-6">
                                ...
                                <h5 class="my-2">
                                    <a href="#" data-fc-type="modal" data-fc-target="task-detail-modal"
                                        class="text-base text-gray-700 dark:text-slate-400 font-medium">Enable analytics
                                        tracking</a>
                                </h5>
                    ...
                    <div class="flex flex-col gap-4 kanban-board custom-scroll overflow-x-hidden overflow-y-auto px-1 h-full"
                        ...
                        <div class="card cursor-pointer">
                            <div class="p-6">
                                ...
                                <h5 class="my-2">
                                    <a href="#" data-fc-type="modal" data-fc-target="task-detail-modal"
                                        class="text-base text-gray-700 dark:text-slate-400 font-medium">Improve animation
                                        loader</a>
                                </h5>
            ...
            <div
                ...
                <div class="px-4 py-8 overflow-y-auto">
                    ...
                    <p class="font-light text-gray-500 dark:text-gray-400">
                        ...
                        delectus asperiores libero voluptas quod perferendis! Voluptate, quod illo rerum? Lorem ipsum dolor
                        sit amet. With supporting text below as a natural lead-in to additional contenposuere erat a ante.
                    </p>
                        ...
                        <div class="mt-5 overflow-hidden">
                            <div id="tabs-with-underline-1"
                                ...
                                <div class="flex gap-5">
                                    ...
                                    <div class="w-full">
                                        <h5 class="mb-2 text-gray-500 dark:text-gray-400 font-semibold">Jeremy Tomlinson
                                        </h5>
                                        <p class="font-light">Cras sit amet nibh libero, in gravida nulla. Nulla vel metus
                                        ...
                                        <div class="mt-5">
                                            <div class="flex gap-5">
                                                ...
                                                <div class="w-full">
                                                    <h5 class="mb-2 text-gray-500 dark:text-gray-400 font-semibold">Thelma
                                                        Fridley</h5>
