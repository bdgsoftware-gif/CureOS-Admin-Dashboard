...
<head>
    @include('layouts.shared/title-meta', ['title' => 'Task List'])
        ...
        <main>
            ...
            <div class="grid xl:grid-cols-3">
                <div class="xl:col-span-2 w-full px-6">
                    ...
                    <div class="flex justify-between items-center my-6">
                        ...
                        <div class="md:flex hidden items-center gap-2.5 text-sm font-semibold">
                            <div class="static overflow-y-hidden">
                                <form>
                                    <div class="relative">
                                        <input type="text" class="form-input border border-dark/10 ps-8"
                    ...
                    <div>
                        <h5 class="mb-3">
                            <a class="text-gray-600 dark:text-gray-200 text-sm" data-fc-target="collapse-task"
                               data-fc-type="collapse" href="#todayTasks" role="button">
                                <i class="ri-arrow-down-s-line text-lg align-middle me-2"></i>Today <span
                                    class="text-gray-500 dark:text-gray-300">(10)</span>
                            </a>
                        </h5>
                            ...
                            <div class="card p-6 mb-8">
                                ...
                                <div class="grid md:grid-cols-2 gap-4 mb-4">
                                    ...
                                    <div class="flex items-center justify-between">
                                        <div class="flex-grow">
                                            <div class="h-8 w-8">
                                                <img class="inline-block h-full w-full rounded-full"
                                                     src="/images/users/avatar-9.jpg" alt="Image Description"
                                                     data-fc-placement="bottom" data-fc-type="tooltip">
                                            </div>
                                            <div
                                                class="bg-dark px-3 py-1.5 rounded-md transition-all text-white z-50 dark:bg-light dark:text-gray-800 absolute open opacity-0 hidden"
                                                role="tooltip">
                                                Assigned to Arya S
                                                <div
                                                    class="bg-dark w-2.5 h-2.5 rotate-45 -z-10 rounded-[1px] dark:bg-light absolute"
                                                    data-fc-arrow></div>
                                            </div>
                                        </div>
                                        <ul class="text-sm text-end">
                                            ...
                                            <li class="inline-block me-2 ms-2">
                                                <span
                                                    class="bg-danger/20 text-danger rounded text-xs/none align-baseline font-medium p-1">High</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                    ...
                                    <div class="flex items-center justify-between">
                                        ...
                                        <div>
                                            <ul class="text-sm text-end">
                                                ...
                                                <li class="inline-block me-2 ms-2">
                                                    <span
                                                        class="bg-info/20 text-info rounded text-xs/none align-baseline font-medium p-1">Medium</span>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                    ...
                    <div>
                        <h5 class="mb-3">
                            <a class="text-gray-600 dark:text-gray-200 text-sm" data-fc-target="collapse-task2"
                               data-fc-type="collapse" href="#todayTasks" role="button">
                                <i class="ri-arrow-down-s-line text-lg align-middle me-2"></i>Upcoming <span
                                    class="text-gray-500 dark:text-gray-300">(5)</span>
                            </a>
                        </h5>
                                    ...
                                    <div class="flex items-center justify-between">
                                        ...
                                        <div>
                                            <ul class="text-sm text-end">
                                                ...
                                                <li class="inline-block me-2 ms-2">
                                                    <span
                                                        class="bg-success/20 text-success rounded text-xs/none align-baseline font-medium p-1">High</span>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                    ...
                    <div>
                        <h5 class="mb-3">
                            <a class="text-gray-600 dark:text-gray-200 text-sm" data-fc-target="collapse-task3"
                               data-fc-type="collapse" href="#todayTasks" role="button">
                                <i class="ri-arrow-down-s-line text-lg align-middle me-2"></i>Other <span
                                    class="text-gray-500 dark:text-gray-300">(3)</span>
                            </a>
                        </h5>
                                ...
                                <div class="grid md:grid-cols-2 gap-4 mb-4">
                                    ...
                                    <div class="flex items-center justify-between">
                                        <div class="flex-grow">
                                            ...
                                            <div
                                                class="bg-dark px-3 py-1.5 rounded-md transition-all text-white z-50 dark:bg-light dark:text-gray-800 absolute open opacity-0 hidden"
                                                role="tooltip" style="left: 747.726px; top: 272px;">
                                                Assigned to Arya S
                                                <div
                                                    class="bg-dark w-2.5 h-2.5 rotate-45 -z-10 rounded-[1px] dark:bg-light absolute"
                                                    data-fc-arrow="" style="left: 66.5px; top: -5px;"></div>
                                            </div>
                                        </div>
                                        <div>
                                            <ul class="text-sm text-end">
                                ...
                                <div class="grid md:grid-cols-2 gap-4">
                                    ...
                                    <div class="flex items-center justify-between">
                                        ...
                                        <ul class="text-sm text-end">
                                            ...
                                            <li class="inline-block me-2 ms-2">
                                                <span
                                                    class="bg-success/20 text-success rounded text-xs/none align-baseline font-medium p-1">Low</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                ...
                <div class="col-span-1">
                    <div class="card p-6 xl:rounded-none xl:m-0 m-6">
                        <div class="dropdown float-right h-4">
                            ...
                            <div
                                class="fc-dropdown fc-dropdown-open:opacity-100 opacity-0 min-w-40 z-50 transition-all duration-300 bg-white dark:bg-gray-800 shadow-lg border border-gray-200 dark:border-gray-600 rounded-md py-1 absolute hidden">
                                <a class="flex items-center py-1.5 px-4 text-sm text-gray-500 hover:bg-slate-100 hover:text-slate-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-300"
                        ...
                        <div class="">
                            <div class="w-auto">
                                <h4 class="text-base mb-2.5 font-semibold text-gray-500 dark:text-gray-300">Draft the
                                    new contract document for sales team</h4>
                                ...
                                <div class="flex flex-wrap items-center gap-y-3">
                                    <div class="sm:w-1/2 px-3">
                                        ...
                                        <div class="flex items-center">
                                            <img src="/images/users/avatar-9.jpg" alt="Arya S"
                                                 class="h-6 rounded-full me-3">
                                            <div>
                                                <h5 class="text-sm">
                                                    Arya Stark
                                                </h5>
                                                                ...
                                                                <button type="button" class="ql-blockquote">
                                                                    <svg viewBox="0 0 18 18">
                                                                        <rect class="ql-fill ql-stroke" height="3"
                                                                              width="3" x="4" y="5"></rect>
                                                                        <rect class="ql-fill ql-stroke" height="3"
                                                                              width="3" x="11" y="5"></rect>
                                ...
                                <div class="flex items-center gap-2 mt-1.5">
                                    ...
                                    <label class="font-semibold text-gray-500 dark:text-gray-300 text-sm"
                                           for="checklist1">
                                        ...
                                        <div class="flex justify-between items-center">
                                            <div class="flex items-center gap-3">
                                                <div class="w-auto">
                                                    <div class="w-12 h-12">
                                                            <span
                                                                class="h-full w-full inline-flex items-center justify-center bg-primary text-white font-semibold rounded">
                                                                ZIP
                                                            </span>
                                                    </div>
                                                </div>
                                                <div class="">
                                                    <a href="javascript:void(0);"
                                                       class="text-sm text-gray-400 font-bold">sales-assets.zip</a>
                                    ...
                                    <div class="p-1.5">
                                        <div class="flex justify-between items-center">
                                            <div class="flex items-center gap-3">
                                                ...
                                                <div class="">
                                                    <a href="javascript:void(0);"
                                                       class="text-sm text-gray-400 font-bold">new-contarcts.docx</a>
                                ...
                                <div class="mt-6">
                                    <div class="w-full">
                                        ...
                                        <div class="flex mt-6 p-1.5">
                                            <img src="/images/users/avatar-9.jpg" class="rounded-full me-3 h-9"
                                                 alt="Arya Stark">
                                            <div class="w-full">
                                                <h5 class="text-sm">
                                        ...
                                        <div class="flex mt-3 p-1.5">
                                            <img src="/images/users/avatar-5.jpg" class="rounded-full me-3 h-9"
                                                 alt="Dominc B">
                                            <div class="w-full">
                                                <h5 class="text-sm">
                                ...
                                <div class="flex pt-3">
                                    <div class="w-full">
                                        <div class="border rounded border-gray-300 dark:border-gray-700">
                                            <form action="#" class="">
                                                <textarea rows="3"
                                                          class="form-input text-gray-400 border-0 resize-none placeholder:text-gray-400"
                                                          placeholder="Your comment..."></textarea>
                                                <div class="p-2 bg-gray-400/10 dark:">
                                                    <div class="flex items-center gap-2">
                                                        <a href="#"
                                                           class="btn btn-sm bg-light dark:bg-gray-600 text-gray-950 dark:text-white"><i
                                                                class="ri-upload-line text-sm"></i></a>
                                                        <a href="#"
                                                           class="btn btn-sm bg-light dark:bg-gray-600 text-gray-950 dark:text-white"><i
                                                                class="ri-at-line text-sm"></i></a>
                                                        <button type="submit"
                                                                class="btn btn-sm bg-success text-white ms-auto"><i
                                                                class="ri-send-plane-2-line me-1"></i>Submit
                                                        </button>
                                                    </div>
                                                </div>
                                            </form>
...
@vite(['resources/js/app.js', 'resources/js/pages/apps-tasks.js'])
