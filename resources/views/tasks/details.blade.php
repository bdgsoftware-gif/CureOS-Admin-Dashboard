        ...
        <div class="xl:col-span-2">
            ...
            <div class="card mb-6">
                <div class="p-6">
                        ...
                        <div class="grid sm:grid-cols-3 gap-3">
                            <div class="col-span-1">
                                ...
                                <div class="flex items-center gap-3 mt-1">
                                    <img src="/images/users/avatar-2.jpg" alt="" class="h-6 rounded-full">
                                    <div class="">
                    ...
                    <p class="text-gray-400">This is a wider card with supporting text below as a natural lead-in to
                        additional content. This content is a little bit longer. Some quick example text to build on the
                    ...
                    <div class="mt-8">
                        ...
                        <div class="mb-1">
                            <input class="form-checkbox rounded text-primary" type="checkbox" id="customckeck1" checked>
                            <label class="ms-1.5 text-gray-600" for="customckeck1">Find out the old contract
                                documents</label>
                        </div>
                        <div class="mb-1">
                            <input class="form-checkbox rounded text-primary" type="checkbox" id="customckeck1" checked>
                            <label class="ms-1.5 text-gray-600" for="customckeck1">Organize meeting sales associates to
                                understand need in detail</label>
                        </div>
                        <div class="mb-1">
                            <input class="form-checkbox rounded text-primary" type="checkbox" id="customckeck1" checked>
                            <label class="ms-1.5 text-gray-600" for="customckeck1">Make sure to cover every small
                                details</label>
                        </div>
                    </div>
                ...
                <div class="p-6">
                    ...
                    <div class="mt-7">
                        ...
                        <div class="flex gap-3">
                            <img src="/images/users/avatar-3.jpg" alt="" class="h-8 rounded-full">
                            <div class="w-full">
                                <h5 class="mb-2">Jeremy Tomlinson
                                    <small class="float-right">5 hours ago</small>
                                </h5>
                                <p>Nice work, makes me think of The Money Pit.</p>
                                <a href="javascript: void(0);" class="block mt-2 font-light"><i class="ri-reply-line"></i>
                                    Reply</a>
                                <!-- chat-end -->

                                <div class="mt-5">
                                    <div class="flex gap-3">
                                        <img src="/images/users/avatar-4.jpg" alt="" class="h-8 rounded-full">
                                        <div class="w-full">
                                            <h5 class="mb-2">Thelma Fridley
                                                <small class="float-right">3 hours ago</small>
                                            </h5>
                                            <p>i'm in the middle of a timelapse animation myself! (Very different
                                                though.) Awesome stuff.</p>
                                            <a href="javascript: void(0);" class="block mt-2 font-light"><i
                    ...
                    <div class="text-center mt-3">
                        <a href="javascript:void(0);" class="text-danger"><i class="ri-loader-2-line me-1"></i> Load
                            more </a>
                    </div> <!-- link-end -->

                    <div class="mt-7 border rounded-md">
                        <textarea rows="3" class="border-0 w-full focus:outline-0 focus:border-0 focus:ring-0"
                            placeholder="Your comment..."></textarea>
                        <div class="px-3 py-2 bg-gray-50 flex justify-between items-center">
                            <div>
                                <a href="#" class="btn btn-sm px-1 hover:bg-light hover:text-slate-900"><i
        ...
        <div class="col-span-1">
            ...
            <div class="card">
                <div class="p-6">
                    ...
                    <form action="/" method="post" class="dropzone mb-5" id="myAwesomeDropzone"
                    ...
                    <div class="border rounded-md border-gray-200 p-3 mb-2 dark:border-gray-600">
                        ...
                        <div class="flex items-center gap-3">
                            <span
                                class="flex items-center justify-center bg-primary/10 text-primary font-semibold rounded-md w-12 h-12">
                                ZIP
                            </span>
                            <div>
                                <a href="javascript:void(0);" class="font-semibold">CureOS-sketch-design.zip</a>
                                <p>2.3 MB</p>
                            </div>
                        </div>
                    </div> <!-- border-end -->
...
@section('script')
    @vite(['resources/js/pages/apps-tasks-details.js'])
@endsection
