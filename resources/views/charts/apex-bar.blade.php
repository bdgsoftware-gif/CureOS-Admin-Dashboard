@extends('layouts.app', ['title' => 'Scatter Charts', 'subTitle' => 'Charts', 'pageTitle' => 'Scatter Chart'])
    ...
    <div class="grid xl:grid-cols-2 gap-6">
        ...
        <div class="card">
            <div class="p-6">
                ...
                <div dir="ltr">
                    <div id="full-stacked-bar" class="apex-charts" data-colors="#ffbc00,#39afd1,#6c757d,#e3eaef,#3e60d5">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="p-6">
                ...
                <div dir="ltr">
                    <div id="datalables-bar" class="apex-charts"
                        data-colors="#3e60d5,#47ad77,#fa5c7c,#6c757d,#39afd1,#2b908f,#ffbc00,#90ee7e,#f48024,#212730"></div>
                </div>
            </div>
        </div>
        <!-- end card -->
