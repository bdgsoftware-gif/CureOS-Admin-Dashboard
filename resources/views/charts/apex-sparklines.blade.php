@extends('layouts.app', ['title' => 'Sparklines Chart', 'subTitle' => 'Chart', 'pageTitle' => 'Sparklines Chart'])
                            ...
                            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                ...
                                <thead>
                                    <tr class="bg-gray-100 dark:bg-gray-900/50">
                                        ...
                                        <th scope="col" class="px-6 py-3 text-start font-semibold">Percentage of
                                            Portfolio</th>
