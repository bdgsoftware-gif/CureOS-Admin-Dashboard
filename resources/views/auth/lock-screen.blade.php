                ...
                <div class="card overflow-hidden">
                    ...
                    <div class="p-9">
                        <div class="text-center mx-auto w-3/4">
                            <h4 class="text-dark/70 text-center text-lg font-bold dark:text-light/80 mb-2">Reset
                                Password</h4>
                            <p class="text-gray-400 mb-9">Enter your email address and we'll send you an email with
                        ...
                        <form action="#">
                            ...
                            <div class="text-center mb-6">
                                <button class="btn bg-primary text-white" type="submit"> Reset Password </button>
                            </div>
