                            ...
                            <div class="mb-6">
                                <div class="flex justify-between items-center mb-2">
                                    ...
                                    <a href="{{ route('second', ['auth', 'recoverpw']) }}"
                                        class="text-emerald-600 dark:text-emerald-400 text-xs hover:text-emerald-700 dark:hover:text-emerald-300 transition-colors underline decoration-dashed underline-offset-4">
