...
<div class="bg-white lg:max-w-[480px] z-10 p-12 relative w-full h-full border-t-[3px] border-primary dark:bg-gray-800">
    <div class="flex flex-col h-full gap-4">
        ...
        <div class="my-auto">
            ...
            <p class="text-gray-400 mb-9">EnDon't have an account? Create your account, it takes less than a minute</p>

            <!-- form -->
            <form action="#">
                <div class="mb-6 space-y-2">
                    <label for="fullname" class="font-semibold text-gray-500">Full Name</label>
                    <input class="form-input" type="text" id="fullname" required="" placeholder="Enter your Name">
                </div>
                <div class="mb-6 space-y-2">
                ...
                <div class="text-center mt-9">
                    <p class="text-gray-400 text-base mb-6">Create account using</p>
        ...
        <footer class="text-center justify-center h-14 -mb-12">
            Already have account? <a href="{{ route('second', ['auth', 'login-2'])}}" class="text-muted ms-1 link-offset-3 underline-offset-4"><b>Log In</b></a>
        </footer>
    </div>
</div>
