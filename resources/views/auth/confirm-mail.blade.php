                ...
                <div class="card overflow-hidden">
                    ...
                    <div class="p-9">
                        <div class="text-center mx-auto w-3/4">
                            ...
                            <h4 class="text-dark/70 text-center text-lg font-bold dark:text-light/80 mb-2 mt-9">Please
                                check your email</h4>
                            <p class="text-gray-400 mb-9">A email has been send to youremail@domain.com. Please check
                                for an email from company and click on the included link to reset your password.</p>
                        </div>

                        <form action="#">
                            <div class="text-center mb-6">
                                <button class="btn bg-primary text-white" type="submit"><i
                                        class="ri-home-4-line me-1.5"></i> Back To Home </button>
                            </div>
                        </form>
                    </div>
                </div>
