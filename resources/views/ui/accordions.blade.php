@extends('layouts.app', ['title' => 'Accordions', 'subTitle' => 'Components', 'pageTitle' => 'Accordions'])
            ...
            <div class="p-6">
                ...
                <div class="pt-5">
                    <div class="border divide-y rounded-md dark:border-gray-700 dark:divide-gray-700"
                        ...
                        <!-- Accordion item one -->
                        <button data-fc-type="collapse"
                            class="fc-collapse-open:text-primary fc-collapse-open:bg-primary/10 py-2 px-5 inline-flex items-center justify-between gap-x-3 w-full text-sm font-medium text-left transition text-gray-500 dark:text-gray-200">
                            <span>Accordion Item #1</span>
                            <span
                                class="ri-arrow-down-s-line text-xl block transition-all fc-collapse-open:rotate-180"></span>
                        </button> <!-- button end -->
            ...
            <div class="p-6">
                ...
                <div class="pt-5">
                    <div data-fc-type="accordion" class="space-y-3">
                        ...
                        <div class="card">
                            <button data-fc-type="collapse"
                                class="py-2 px-5 inline-flex items-center justify-between gap-x-3 w-full font-semibold text-left transition text-gray-500 dark:text-gray-200">
                ...
                <div class="pt-5">
                    <div data-fc-type="accordion" class="space-y-3">
                        ...
                        <div class="rounded-md border border-gray-200 dark:border-gray-700">
                            <button data-fc-type="collapse"
                                class="fc-collapse-open:text-primary py-2 px-5 inline-flex items-center justify-between gap-x-3 w-full text-left font-medium transition text-gray-500 dark:text-gray-200">
                                <span>Accordion Item #1</span>
                                <span
                                    class="ri-arrow-down-s-line text-xl block transition-all fc-collapse-open:rotate-180"></span>
                            </button> <!-- button end -->
            ...
            <div class="p-6">
                ...
                <div class="pt-5">
                    <div data-fc-type="accordion" class="space-y-3">
                        ...
                        <div class="rounded-md border border-gray-200 dark:border-gray-700">
                            <button data-fc-type="collapse"
                                class="fc-collapse-open:text-primary py-3 px-5 inline-flex items-center justify-between gap-x-3 w-full text-left font-medium transition text-gray-500 dark:text-gray-200">
                                <span>Accordion Item #1</span>
                            </button> <!-- button end -->
            ...
            <div class="p-6">
                ...
                <div class="pt-5">
                    <div data-fc-type="accordion" id="parent-accordion">
                        ...
                        <!-- Accordion item one -->
                        <button data-fc-type="collapse" data-fc-parent="parent-accordion"
                            class="fc-collapse-open:text-primary py-2 px-5 inline-flex items-center gap-x-3 w-full font-semibold text-left transition text-gray-500 dark:text-gray-200">
                            <span class="ri-add-line text-lg block fc-collapse-open:hidden"></span>
                            <span class="ri-subtract-line text-lg hidden fc-collapse-open:block"></span>
                            Accordion Item #1
                        </button> <!-- button end -->
                        ...
                        <div class="w-full overflow-hidden transition-[height] duration-300">
                            <div data-fc-type="accordion" class="ps-6" id="child-accordion">
                                ...
                                <button data-fc-type="collapse" data-fc-parent="child-accordion"
                                    class="fc-collapse-open:text-primary py-2 px-5 inline-flex items-center gap-x-3 w-full font-semibold text-left transition text-gray-500 dark:text-gray-200">
                                    <span class="ri-add-line text-lg block fc-collapse-open:hidden"></span>
                                    <span class="ri-subtract-line text-lg hidden fc-collapse-open:block"></span>
