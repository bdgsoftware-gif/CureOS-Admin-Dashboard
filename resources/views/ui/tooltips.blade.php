@extends('layouts.app', ['title' => 'Tooltip', 'subTitle' => 'Components', 'pageTitle' => 'Tooltip'])
...
@section('content')
    <div class="grid 2xl:grid-cols-2 grid-cols-1 gap-6">
            ...
            <div class="p-6">
                ...
                <div class="flex flex-wrap gap-2">
                    ...
                    <div>
                        ...
                        <div class="bg-slate-700 hidden ms-1 px-2 py-1 rounded transition-all text-white opacity-0 z-50"
                            role="tooltip">
                            Right Tooltip
                            <div data-fc-arrow class="bg-slate-700 w-2.5 h-2.5 rotate-45 -z-10 rounded-[1px]"></div>
                        </div>
                    ...
                    <div>
                        ...
                        <div class="bg-slate-700 hidden me-1 px-2 py-1 rounded transition-all text-white opacity-0 z-50"
                            role="tooltip">
                            Left Tooltip
                            <div data-fc-arrow class="bg-slate-700 w-2.5 h-2.5 rotate-45 -z-10 rounded-[1px]"></div>
                        </div>
        ...
        <div class="card">
            <div class="p-6">
                <h4 class="card-title mb-4">Color Tooltips</h4>
                ...
                <div class="flex flex-wrap gap-2">
                    <div>
                        ...
                        <div class="bg-primary hidden px-2 py-1 rounded transition-all text-white opacity-0 z-50"
                            role="tooltip">
                            Primary Tooltip
                    ...
                    <div>
                        ...
                        <div class="bg-success hidden px-2 py-1 rounded transition-all text-white opacity-0 z-50"
                            role="tooltip">
                            success Tooltip
                    ...
                    <div>
                        ...
                        <div class="bg-info hidden px-2 py-1 rounded transition-all text-white opacity-0 z-50"
                            role="tooltip">
                            Info Tooltip
        ...
        <div class="card">
            <div class="p-6">
                <h4 class="card-title mb-4">Real Example</h4>

                <div class="text-muted">
                    You can use frost
                    <span class="underline italic cursor-help" data-fc-type="tooltip">tooltip</span>
                    <span class="bg-slate-700 hidden px-2 py-1 rounded transition-all text-white opacity-0 z-50"
                        role="tooltip"> Why you see at bottom
                    ...
                    <span class="underline italic cursor-help" data-fc-placement="bottom"
                        data-fc-type="tooltip">large</span>
                    <div class="hidden">
                        <div
                            class="max-w-xs bg-white border border-gray-100 text-left rounded-lg dark:bg-gray-800 dark:border-gray-600 p-3">
