@extends('layouts.app', ['title' => 'Skeleton', 'subTitle' => 'Components', 'pageTitle' => 'Skeleton'])
                            ...
                            <div class="rounded-md">
                                ...
                                <div class="p-6">
                                    ...
                                    <p>Some quick example text to build on the card title and make up the bulk of the card's
                                        content.</p>
                                    <button type="button" class="btn bg-primary text-white mt-5">Go somewhere</button>
                                    <!-- button-end -->
                                </div>
                                ...
                                <div class="p-6">
                                    ...
                                    <ul class="space-y-2 mt-5">
                                        <div class="flex gap-1">
                                            <li class="w-3/5 h-4 animate-pulse cursor-wait bg-gray-200 dark:bg-gray-700">
                                            </li>
                                            <li class="w-2/5 h-4 animate-pulse cursor-wait bg-gray-200 dark:bg-gray-700">
                                            </li>
                                        </div>
                                        <div class="flex gap-1">
                                            <li class="w-2/5 h-4 animate-pulse cursor-wait bg-gray-200 dark:bg-gray-700">
