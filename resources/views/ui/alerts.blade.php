            ...
            <div class="p-6">
                ...
                <div class="pt-5">
                    <div class="space-y-4">
                        ...
                        <div class="bg-primary/10 text-primary border border-primary/20 text-sm rounded-md py-3 px-5"
                            role="alert">
                            <span class="font-bold">Primary</span> - A simple primary alert—check it out!
                        </div>
                        <div class="bg-secondary/10 text-secondary border border-secondary/20 text-sm rounded-md py-3 px-5"
                            role="alert">
                        ...
                        <div class="bg-danger/10 text-danger border border-danger/20 text-sm rounded-md py-3 px-5"
                            role="alert">
            ...
            <div class="p-6">
                ...
                <div class="pt-5">
                    <div class="space-y-4">
                        ...
                        <div id="dismiss-example-primary"
                            class="border bg-primary text-white border-primary rounded-md py-3 px-5 flex justify-between items-center">
                            <p>
                                <span class="font-bold">Primary</span> - A simple primary alert—check it out!
                            </p>
                        ...
                        <div id="dismiss-example-secondary"
                            class="border bg-secondary text-white border-secondary rounded-md py-3 px-5 flex justify-between items-center">
                            <p>
                                <span class="font-bold">Secondary</span> - A simple primary alert—check it out!
                            </p>
                        ...
                        <div id="dismiss-example-success"
                            class="border bg-success text-white border-success rounded-md py-3 px-5 flex justify-between items-center">
                            <p>
                                <span class="font-bold">Success</span> - A simple primary alert—check it out!
                            </p>
                        ...
                        <div id="dismiss-example-danger"
                            class="border bg-danger text-white border-danger rounded-md py-3 px-5 flex justify-between items-center">
                            <p>
                        ...
                        <div id="dismiss-example-warning"
                            class="border bg-warning/10 text-warning border-warning/20 rounded py-3 px-5 flex justify-between items-center">
                            <p>
                                <span class="font-bold">Warning</span> - A simple primary alert—check it out!
                            </p>
                        ...
                        <div id="dismiss-example-light"
                            class="border bg-light/10 text-light border-light/20 rounded py-3 px-5 flex justify-between items-center">
                            <p>
                                <span class="font-bold">Light</span> - A simple primary alert—check it out!
                            </p>
                        ...
                        <div id="dismiss-example-dark"
                            class="border bg-dark/10 text-dark border-dark/20 rounded py-3 px-5 flex justify-between items-center">
                            <p>
                                <span class="font-bold">Dark</span> - A simple primary alert—check it out!
                            </p>
            ...
            <div class="p-6">
                ...
                <div class="pt-5">
                    <div class="space-y-4">
                        ...
                        <div class="bg-primary/10 text-primary border border-primary/20 text-sm rounded-md py-3 px-5"
                            role="alert">
                            A simple primary alert with <a href="#" class="alert-link"><span class="font-bold">an
                                    example link</span></a>. Give it a click if you like.
                        </div>
                        <div class="bg-secondary/10 text-secondary border border-secondary/20 text-sm rounded-md py-3 px-5"
                            role="alert">
                            A simple primary alert with <a href="#" class="alert-link"><span class="font-bold">an
                        ...
                        <div class="bg-warning/10 text-warning border border-warning/20 text-sm rounded-md py-3 px-5"
                            role="alert">
                            A simple primary alert with <a href="#" class="alert-link"><span class="font-bold">an
                                    example link</span></a>. Give it a click if you like.
                        </div>
                        <div class="bg-info/10 text-info border border-info/20 text-sm rounded-md py-3 px-5"
                            role="alert">
                            A simple primary alert with <a href="#" class="alert-link"><span class="font-bold">an
                                    example link</span></a>. Give it a click if you like.
                        </div>
                        <div class="bg-light/10 text-light border border-light/20 text-sm rounded-md py-3 px-5"
                            role="alert">
                            A simple primary alert with <a href="#" class="alert-link"><span class="font-bold">an
                                    example link</span></a>. Give it a click if you like.
                        </div>
                        <div class="bg-dark/10 text-dark border border-dark/20 text-sm rounded-md py-3 px-5"
                            role="alert">
                            A simple primary alert with <a href="#" class="alert-link"><span class="font-bold">an
                                    example link</span></a>. Give it a click if you like.
                        </div>
                    ...
                    <div class="bg-info/10 border border-info/20 text-info rounded-md p-4" role="alert">
                        <div class="flex flex-col items-center text-center">
                            ...
                            <div class="mt-3">
                                ...
                                <p class="text-sm">Whenever you need to, be sure to use margin utilities to keep things
                                    nice and tidy.</p>
                            </div>
                        </div> <!-- flex end -->
