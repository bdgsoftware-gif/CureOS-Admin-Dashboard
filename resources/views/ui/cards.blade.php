@extends('layouts.vertical', ['title' => 'Cards', 'subTitle' => 'Components', 'pageTitle' => 'Cards'])
...
<div class="grid lg:grid-cols-4 sm:grid-cols-2 gap-6">
    ...
    <div class="card">
        ...
        <div class="p-6">
            ...
            <p class="mt-1 text-gray-800 dark:text-gray-400 mb-4">Some quick example text to build on the card title and make up the bulk of the card's content. Some quick example text to build on the card title and make up</p>
    ...
    <div class="card">
        ...
        <div class="p-6"> Some quick example text to build on the card title and make up the bulk of the card's content.</p>
            <div class="pt-6 flex gap-5">
                <a href="javascript: void(0);" class="text-primary">Card link</a><!-- Button End -->
                <a href="javascript: void(0);" class="text-primary">Another link</a><!-- Button End -->
            </div>
...
<div class="grid sm:grid-cols-2 gap-6 mt-4">
    <div class="card">
        <div class="p-6">
            ...
            <p class="mt-1 text-gray-800 dark:text-gray-400 mb-4">With supporting text below as a natural lead-in to additional content. </p>
...
<div class="grid sm:grid-cols-3 gap-6">
    <div class="card border border-secondary">
        <div class="p-6">
            <h3 class="text-base font-bold text-secondary dark:text-white mb-2">Special title treatment</h3><!-- end card title -->
    ...
    <div class="card border border-primary">
        <div class="p-6">
            <h3 class="text-base font-bold text-primary dark:text-white mb-2">Special title treatment</h3><!-- end card title -->
            <p class="mt-1 text-gray-800 dark:text-gray-400 mb-3">With supporting text below as a natural lead-in to additional content.</p>
            <a class="btn bg-primary text-white mt-2" href="#">Button</a><!-- Button End -->
        </div>
    </div><!-- Card End -->
    ...
    <div class="card">
        <div class="grid sm:grid-cols-3">
            ...
            <div class="p-6 sm:col-span-2">
                ...
                <p class="mt-1 text-gray-800 dark:text-gray-400">This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
...
<div class="grid lg:grid-cols-4 sm:grid-cols-2 gap-6">
    <div class="card relative">
        ...
        <div class="p-6">
            ...
            <a class="btn bg-primary text-white mt-2 after:absolute after:inset-0" href="#">Go somewhere</a><!-- Button End -->
        </div>
    </div><!-- Card End -->
    ...
    <div class="card relative">
        ...
        <div class="p-6">
            ...
            <p class="mt-1 text-gray-800 dark:text-gray-400">Some quick example text to build on the card up the bulk of the card's content.</p>
        </div>
    </div><!-- Card End -->
    ...
    <div class="card relative">
        ...
        <div class="p-6">
            <h3 class="card-title mb-3">Card with stretched link</h3><!-- end card title -->
            <a class="btn bg-info text-white mt-2 after:absolute after:inset-0" href="#">Go somewhere</a><!-- Button End -->
        </div>
    </div><!-- Card End -->
...
<div class="grid sm:grid-cols-3 gap-6 sm:gap-0">
    <div class="card sm:rounded-none sm:rounded-s-md h-full">
        <img class="w-full h-auto sm:rounded-tl-md sm:rounded-none rounded-t-md" src="/images/small/small-1.jpg" alt="Image Description">
        <div class="p-6">
            <h3 class="card-title mb-4">Card title</h3><!-- end card title -->
            <p class="mt-1 text-gray-800 dark:text-gray-400">This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
    ...
    <div class="card sm:rounded-none h-full">
        <img class="w-full h-auto sm:rounded-none rounded-md" src="/images/small/small-2.jpg" alt="Image Description">
        <div class="p-6">
            <h3 class="card-title mb-4">Card title</h3><!-- end card title -->
            <p class="mt-1 text-gray-800 dark:text-gray-400">This card has supporting text below as a natural lead-in to additional content.</p>
            <p class="mt-5 pb-5"><small>Last updated 3 mins ago</small></p>
        </div>
    </div><!-- Card End -->

    <div class="card sm:rounded-none sm:rounded-e-md h-full">
        <img class="w-full h-auto sm:rounded-tr-md sm:rounded-none rounded-t-md" src="/images/small/small-3.jpg" alt="Image Description">
        <div class="p-6">
            <h3 class="card-title mb-4">Card title</h3><!-- end card title -->
            <p class="mt-1 text-gray-800 dark:text-gray-400">This is a wider card with supporting text below as a natural lead-in to additional content. This card has even longer content than the first to show that equal height action.</p>
            <p class="mt-5"><small>Last updated 3 mins ago</small></p>
        </div>
    </div><!-- Card End -->
</div><!-- Grid End -->
