...
<div class="grid xl:grid-cols-2 grid-cols-1 gap-6">
    ...
    <div class="card p-6">
        ...
        <div class="flex flex-wrap items-end gap-6">
            <div class="w-8 h-8 justify-center items-center flex bg-primary text-white rounded-md"><span class="">CT</span></div>

            <div class="w-12 h-12 justify-center items-center flex bg-success text-white rounded-md"><span class="text-lg">CT</span></div>

            <div class="w-16 h-16 justify-center items-center flex bg-info/20 text-info rounded-md"><span class="text-xl">CT</span></div>

            <div class="w-24 h-24 justify-center items-center flex bg-danger text-white rounded-md"><span class="text-2xl">CT</span></div>

            <div class="w-32 h-32 justify-center items-center flex bg-warning/25 text-warning rounded-md"><span class="text-4xl">CT</span></div>
        </div>
    </div>
    ...
    <div class="xl:col-span-2">
        <div class="card p-6">
            ...
            <div class="flex flex-wrap gap-3">
                ...
                <div class="lg:w-1/6 md:1/3 px-3">
                    <img src="/images/small/small-3.jpg" alt="" class="w-52 p-1 border border-gray-200 rounded bg-slate-100">
                    <p class="text-info mt-2"><code>.rounded .border</code></p>
                </div>
                <div class="lg:w-1/6 md:1/3 px-3">
                    <img src="/images/users/avatar-8.jpg" alt="" class="w-32 rounded-full p-1 border border-gray-200 bg-slate-100">
