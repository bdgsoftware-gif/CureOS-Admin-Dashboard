@extends('layouts.vertical', ['title' => 'Offcanvas', 'subTitle' => 'Components', 'pageTitle' => 'Offcanvas'])
...
<div class="grid lg:grid-cols-2 grid-cols-1 gap-6">
    <div class="card">
        <div class="p-6">
            ...
            <div id="default-offcanvas" class="fc-offcanvas-open:translate-x-0 hidden -translate-x-full fixed top-0 start-0 transition-all duration-300 transform h-full max-w-xs w-full z-50 bg-white border-r dark:bg-gray-800 dark:border-gray-700" tabindex="-1">
    ...
    <div class="card">
        <div class="p-6">
            ...
            <div>
                ...
                <div class="fc-offcanvas-open:translate-x-0 hidden -translate-x-full fixed top-0 start-0 transition-all duration-300 transform h-full max-w-xs w-full z-50 bg-white border-r dark:bg-gray-800 dark:border-gray-700" tabindex="-1">
                    <div class="flex justify-between items-center py-2 px-4 border-b dark:border-gray-700">
                        <h3 class="font-medium">
                            Offcanvas title
                        </h3>
    ...
    <div class="card">
        <div class="p-6">
            ...
            <div class="flex flex-wrap gap-4">
                ...
                <div class="fc-offcanvas-open:translate-x-0 hidden -translate-x-full fixed top-0 start-0 transition-all rtl:translate-x-full duration-300 transform h-full max-w-xs w-full z-50 bg-white border-r dark:bg-gray-800 dark:border-gray-700" tabindex="-1">
                    <div class="flex justify-between items-center py-2 px-4 border-b dark:border-gray-700">
                        <h3 class="font-medium">
                            Offcanvas title
                        </h3>
                ...
                <div class="fc-offcanvas-open:translate-x-0 translate-x-full fixed top-0 end-0 transition-all duration-300 rtl:-translate-x-full transform h-full max-w-xs w-full  z-50 bg-white border-l dark:bg-gray-800 dark:border-gray-700 hidden">
                    <div class="flex justify-between items-center py-2 px-4 border-b dark:border-gray-700">
                        <h3 class="font-medium">
                            Offcanvas title
                        </h3>
