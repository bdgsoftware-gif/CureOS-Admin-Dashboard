@extends('layouts.app', ['title' => 'Typography', 'subTitle' => 'Components', 'pageTitle' => 'Typography'])
...
@section('content')
    <div class="grid lg:grid-cols-2 grid-cols-1 gap-6">
        ...
        <div class="card">
            <div class="p-6">
                <h4 class="card-title mb-4">Text gradient Examples</h4>

                <div class="space-y-4">
                    <p class="text-3xl bg-gradient-to-r from-cyan-500 to-blue-500 bg-clip-text text-transparent">The quick
        ...
        <div class="card">
            <div class="p-6">
                <h4 class="card-title mb-4">Text Colored Decoration</h4>

                <div class="space-y-4">
                    <p class="text-lg underline decoration-primary">The quick brown fox jumps over the lazy dog.</p>
                    <p class="text-lg overline decoration-success decoration-2">The quick brown fox jumps over the lazy dog.
                    </p>
        ...
        <div class="card">
            <div class="p-6">
                <h4 class="card-title mb-4">Text Decoration Style</h4>
