@extends('layouts.app', ['title' => 'Buttons', 'subTitle' => 'Components', 'pageTitle' => 'Buttons'])
    ...
    <div class="grid xl:grid-cols-2 gap-6">
        ...
        <div class="card p-6">
            ...
            <div class="flex flex-wrap items-center gap-3">
                ...
                <button type="button"
                    class="btn border-light text-light hover:bg-light hover:text-gray-800 dark:text-slate-200">Light</button>
                <button type="button"
                    class="btn border-dark text-slate-900 dark:text-slate-200 hover:bg-dark hover:text-white">Dark</button>
            </div>
        </div>
        ...
        <div class="card p-6">
            ...
            <div class="flex flex-wrap items-center gap-3">
                ...
                <button type="button"
                    class="btn rounded-full border-light text-light hover:bg-light hover:text-gray-800 dark:text-slate-200">Light</button>
                <button type="button"
                    class="btn rounded-full border border-dark text-slate-900 dark:text-slate-200 hover:bg-dark hover:text-white">Dark</button>
            </div>
        </div>
        ...
        <div class="card p-6">
            ...
            <div class="flex flex-wrap items-center gap-3">
                ...
                <button type="button"
                    class="btn bg-dark/25 text-slate-900 dark:text-slate-200 hover:bg-dark hover:text-white">Dark</button>
            </div>
        </div>
        ...
        <div class="card p-6">
            ...
            <div class="flex flex-wrap items-center gap-3">
                ...
                <button type="button"
                    class="btn rounded-full bg-dark/25 text-slate-900 dark:text-slate-200 hover:bg-dark hover:text-white">Dark</button>
            </div>
        </div>
        ...
        <div class="card p-6">
            ...
            <div class="flex flex-wrap items-center gap-3">
                ...
                <button type="button" class="btn bg-primary text-white"><i
                        class="ri-shield-star-line text-sm"></i></button>
                <button type="button" class="btn bg-success text-white"><i
                        class="ri-thumb-up-line text-sm"></i></button>
                ...
                <button type="button" class="btn bg-light text-gray-800"><i
                        class="ri-hearts-fill text-sm me-1.5"></i><span>Like</span></button>
                <button type="button" class="btn bg-warning text-white"><i
                        class="ri-rocket-line text-sm me-1.5"></i><span>Launch</span></button>
                <button type="button" class="btn bg-info text-white"><i
                        class="ri-server-line text-sm me-1.5"></i><span>Cloud Hosting</span></button>
                <button type="button"
                    class="btn rounded border border-success text-success hover:bg-success hover:text-white"><i
                        class="ri-money-pound-circle-line me-1.5"></i><span>Money</span></button>
                <button type="button"
                    class="btn rounded border border-primary text-primary hover:bg-primary hover:text-white"><i
                        class="ri-paypal-line me-1.5"></i><span>Money</span></button>
                <button type="button"
                    class="btn rounded border border-danger text-danger hover:bg-danger hover:text-white"><i
                        class="ri-equalizer-line me-1.5"></i><span>Settings</span></button>
            </div>
        </div>
        ...
        <div class="card p-6">
            ...
            <div class="">
                <div class="inline-flex rounded-md shadow-sm">
                    <button type="button"
                        class="btn bg-light first:rounded-l-lg first:ml-0 last:rounded-r-lg transition-all">
                        Years
                    </button>
                    <button type="button"
                        class="btn bg-light first:rounded-l-lg first:ml-0 last:rounded-r-lg transition-all">
